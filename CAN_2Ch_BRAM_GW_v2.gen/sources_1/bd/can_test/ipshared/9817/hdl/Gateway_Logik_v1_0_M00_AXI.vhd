	        ...
	        if (M_AXI_ARESETN = '0' or init_txn_pulse = '1' ) then                                                 
	          ...
	          if unsigned(read_index)=2 and M_AXI_RVALID = '1' then
	               ...
	               if M_AXI_RDATA(4) = '1' then
	                   if (unsigned(read_index)=3 and M_AXI_RVALID = '1') then
	                       CAN0_FRAME_IsReceived_ID <= M_AXI_RDATA;
	                   elsif (unsigned(read_index)=4 and M_AXI_RVALID = '1') then
	                       CAN0_FRAME_IsReceived_DW1 <= M_AXI_RDATA;
	                   elsif (unsigned(read_index)=5 and M_AXI_RVALID = '1') then
