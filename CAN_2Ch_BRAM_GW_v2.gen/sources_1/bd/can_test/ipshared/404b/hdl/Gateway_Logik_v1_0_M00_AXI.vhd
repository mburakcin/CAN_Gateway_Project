	    	  ...
	    	  if (M_AXI_ARESETN = '0' or init_txn_pulse = '1') then                                                
			    ...
			    if can_enabled_status = '0' then    	                                                                                                   --constant BTR : std_logic_vector (31	    	    		                                                                                       --constant SR : std_logic_vector (31 
                    if unsigned(write_index) = 1 then                                                               --constant STATUS_REG: std_logic_vect
                        ...
                        axi_awaddr <= IER; -- prepare enabling the interrupt  
		      ...
		      if (M_AXI_ARESETN = '0' or init_txn_pulse = '1') then                                                
		        ...
		        if can_enabled_status = '0' then		        
                    ...
                    if unsigned(write_index) = 1 then                             --BRP_VAL :  std_     --constant TXFIFO_DW2 : std_logic_vec
                        ...
                        axi_wdata <= x"00000000";                               --CAN_DATA2    :                                --CAN_DATA2    :           --   constant ADDR_TXHPB_ID  : std_lo                                                                 --   constant ADDR_TXHPB_DW1 : std_lo
	    ...
	    begin                                                                              
	      if (rising_edge (M_AXI_ACLK)) then                                               
	        if (M_AXI_ARESETN = '0' or init_txn_pulse = '1' ) then                                                 
	          ...
	          if unsigned(read_index)=4 and M_AXI_RVALID = '1' and can_enabled_status = '0' then
	          ...
	          elsif (unsigned(read_index)=2 and M_AXI_RVALID = '1' and can_enabled_status = '1') then
