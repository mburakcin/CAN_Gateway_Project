...
#create_clock -period 10.00 -name ref_clk [get_ports clk_100MHz]
#set_property CLOCK_DEDICATED_ROUTE ANY_CMT_COLUMN [get_nets ref_clk]

#set pin(clk_100MHz_1) {PACKAGE_PIN = AA27}

#set_property PACKAGE_PIN G21 [get_ports clk_125MHz_1]
#set_property IOSTANDARD LVDS_25 [get_ports clk_125MHz_1]
#create_clock -name clk_125MHz_1 -period 8.000 [get_ports clk_125MHz_1]
...
#create_clock -period 10.000 -name si570_n_clk [get_ports USER_SI570_N]
...
#create_clock -period 10.000 -name si570_p_clk [get_ports USER_SI570_P]
...
#create_clock -name clk125 -period 8.000 [get_ports {clk_125MHz_1}]

#create_clock -name clk125M -period 8.000 [get_ports clk_125MHz_1]
...
# For CAN0
set_property PACKAGE_PIN A20 [get_ports can_phy_tx_0];
set_property IOSTANDARD LVCMOS33 [get_ports can_phy_tx_0];

set_property PACKAGE_PIN B20 [get_ports can_phy_rx_0];
set_property IOSTANDARD LVCMOS33 [get_ports can_phy_rx_0];

set_property PACKAGE_PIN D20      [get_ports can_phy_tx_1] ;# Bank  47 VCCO - VCC3V3   - IO_L8N_HDGC_AD4N_47
set_property IOSTANDARD  LVCMOS33 [get_ports can_phy_tx_1] ;# Bank  47 VCCO - VCC3V3   - IO_L8N_HDGC_AD4N_47
set_property PACKAGE_PIN E20      [get_ports can_phy_rx_1] ;# Bank  47 VCCO - VCC3V3   - IO_L8P_HDGC_AD4P_47
set_property IOSTANDARD  LVCMOS33 [get_ports can_phy_rx_1] ;# Bank  47 VCCO - VCC3V3   - IO_L8P_HDGC_AD4P_47
#set_property PACKAGE_PIN C22      [get_ports can_phy_tx_1] ;# Bank  47 VCCO - VCC3V3   - IO_L9N_AD3N_47
#set_property IOSTANDARD  LVCMOS33 [get_ports can_phy_tx_1] ;# Bank  47 VCCO - VCC3V3   - IO_L9N_AD3N_47
#set_property PACKAGE_PIN D21      [get_ports can_phy_rx_1] ;# Bank  47 VCCO - VCC3V3   - IO_L9P_AD3P_47
#set_property IOSTANDARD  LVCMOS33 [get_ports can_phy_rx_1] ;# Bank  47 VCCO - VCC3V3   - IO_L9P_AD3P_47
