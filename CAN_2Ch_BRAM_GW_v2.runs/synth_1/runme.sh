...
HD_PWD='/home/upkmy/CAN_2Ch_BRAM_GW_v2/CAN_2Ch_BRAM_GW_v2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log can_test_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source can_test_wrapper.tcl
