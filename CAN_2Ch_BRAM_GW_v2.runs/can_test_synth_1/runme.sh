...
HD_PWD='/home/upkmy/CAN_2Ch_BRAM_GW_v2/CAN_2Ch_BRAM_GW_v2.runs/can_test_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log can_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source can_test.tcl
